...
| tfc\_agent\_replicas | Deployment replicas for Terraform Cloud Agent | `string` | `"2"` | no |
...
| tfc\_agent\_token | Terraform Cloud Agent token. (TFC Organization Settings >> Agents) | `string` | `""` | no |
